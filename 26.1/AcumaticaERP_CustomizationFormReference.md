...
## Contents 
 ...
 Customization Menu............................................................................................................................. 35 

 Customization Project Editor................................................................................................................. 38 

 Customization Projects......................................................................................................................... 42 

 Customized Data Classes....................................................................................................................... 48 
 ...
 Edit Project Items................................................................................................................................. 66 

 Element Inspector................................................................................................................................ 68 
 ...
 Generic Inquiries.................................................................................................................................. 82 

 Import and Export Scenarios................................................................................................................. 84 

 Mobile Application................................................................................................................................ 86 

 Mobile Workspaces............................................................................................................................... 89 

 Modern UI Editor.................................................................................................................................. 91 

 Modern UI Files.................................................................................................................................... 96 

 Project XML Editor................................................................................................................................ 99 

 Push Notifications...............................................................................................................................100 

 Reports.............................................................................................................................................. 102 

 Screen Configurations......................................................................................................................... 104 
...
**Tables to Track Deleted Records...........................................................................................................123** 

**User-Defined Fields............................................................................................................................. 125** 

**Webhooks...........................................................................................................................................127** 

**Web Service Endpoints........................................................................................................................ 129** 
...
### Page Toolbar and More Menu 
 ...
 Table: Add Access Rights for Screen Dialog Box This dialog box opens when you click Add New Record on the page toolbar. You use the dialog box when you’ve configured access rights for multiple screens in a staging tenant and you want to apply the same access rights to a production tenant. You do this by clicking the Included check box in the column header for the needed screens. The dialog box contains the following elements. 
...
- _Copy from Current Tenant_ (default): To copy the access rights from the current tenant.     You select this option when you’re transferring the access rights from the current ten-     ant to a target tenant —for example, from a staging tenant where you’ve configured     and tested specific access rights for multiple screens to a production tenant.     For roles not included in the customization project, the system handles access rights     based on the availability of the form in the target tenant as follows: 

- The form exists in the target tenant: Access rights remain unchanged. 

- The form doesn’t exist in the target tenant (that is, it's a new form with no access     rights specified for it in this tenant): The system sets the access rights to _Revoked_. For details, see _To Add Access Rights to a Project_. 
...
- _Navigation: Search Records_ : The action redirects the user to the form whose ID is speci-     fied in the **Destination Screen** box and on which the user can search for records (such     as an inquiry or a generic inquiry). 
...
- _Navigation: Side Panel_ : The action opens as a side panel the form whose ID is specified     in the **Destination Screen** box. With this option selected, you can specify a form of any     of the following types as the destination: dashboard, report, or generic inquiry. 
...
- For the _Navigation: Search Records_ type: The screen ID of the form to which you want to     redirect the user; this is a form where a user can search for records, such as an inquiry     or a generic inquiry. For example, you might specify this action type with the screen ID     _SO3010PL_ , which is the ID of the list of records for the Sales Orders entry form. 

- For the _Navigation: Create Record_ type: The screen ID of the form to which you want to     redirect the user; this is a form on which a user can create a new record. For example,     you might specify _SO301000_ as the screen ID; it is the ID of the _Sales Orders_ (SO301000)     data entry form. 
...
- _If Available_ : The action will be displayed as a button on the form toolbar and under a     category on the More menu if the action is available for a record based on its state and     if a category is specified for it. If the action is available but no category is specified, the     action will be displayed on the form toolbar and under the **Other** category. If the action     is not available or a record based on its state, it will not be displayed on the form tool-     bar and the More menu. 
...
### Table 
 ...
 Action Type The type of the action. This column can contain one of the following options: 
...
- _Graph Action:_ Read-only. The action that is defined in a graph. This option is not avail-     able for selection when you create an action. 
 ...
 An LLM action that you create on the LLM Prompts (ML202000) form is added to the table as a Graph Action. You can customize this action as you can any other action of the form. You can also specify access rights for it. For details on LLM actions, see Integration with LLM Providers: General Information. 
...
### Page Toolbar and More Menu 
 ...
 Table: Add Business Events Dialog Box This dialog box opens when you click Add New Record on the page toolbar. The dialog box contains the following elements. The table toolbar has only standard buttons. 
...
- _Trigger by Record Change_ : The system processes the subscribers specified on     the **Subscribers** tab when the inquiry results or data provided by the data entry     form have changed in the ways that meet the conditions specified on the **Trig-**     **ger Conditions** tab. The option is available if an inquiry form or data entry form     is specified in the **Screen Name** box. For details on this type of business event,     see _Business Events: Data Change Processing_. 

- _Trigger by Schedule_ : At the times and frequencies specified on the **Schedules**     tab, the system checks the results of the inquiry and processes the subscribers     specified on the **Subscribers** tab if the inquiry results satisfy the conditions     specified on the **Trigger Conditions** tab. The option is available if an inquiry     form is specified in the **Screen Name** box. For more information about this type     of business event, see _Business Events: Scheduled Event Processing_. 

- _Trigger by Action_ : The system processes the subscribers specified on the **Sub-**     **scribers** tab when a user clicks the action specified in the **Action Name** box for     this business event. The option is available if an inquiry form or data entry form     is specified in the **Screen Name** box. For details on this type of business event,     see _Business Events: User-Triggered Processing of Subscribers_. 
...
### Condition Properties Dialog Box 
 ...
 Table: Condition Properties Dialog Box: Table The table toolbar has only standard buttons. 
...
- _Is Not Empty_ : Returns _TRUE_ if the field value is not empty (not null). If you specify a date in the **Value** or **Value 2** box but do not specify a time, the system uses 00:00:00 or 23:59:99 as the time, depending on the condition. 
...
- _@PeriodStart_ and _@PeriodEnd_ : The start and end of the current financial period. The fi-     nancial periods are defined on the _Financial Year_ (GL101000) form.     For more information about financial periods in Acumatica ERP, see _Managing Financial_     _Periods_. 
...
## Customization Project Editor 
 ...
 You can use the Customization Project Editor to develop and manage the content of a customization project. The editor contains separate pages to add and manage items in the currently selected customization project. (See Managing Items in a Project for instructions.) 
...
- The main area, which displays the selected page (Item 3, which shows the _Files_ page) 
...
- Validate a customization project or multiple projects (see _Validation of Customization Projects: ISV Solutions_     for details) 
...
### Form Toolbar 
 ...
 Convert to Modern UI 

 Launches the conversion of all the forms in the customization project to the Modern UI. 
...
## Customized Data Classes 
 ...
 You can customize DAC items for the Self-Service Portal as well. For details on the portal, see SelfService Portal. 
...
### Customize Selector Columns Dialog Box 
 ...
 Table: Customize Selector Columns Dialog Box: Table Toolbar The table toolbar includes the buttons described below. 
...
### Customize Attributes Dialog Box 
 ...
 Table: Customize Attributes Dialog Box: Table Toolbar The table toolbar includes the buttons described below. 
...
<!-- PAGE_BREAK -->
 ...
 The system currently inserts the deprecated PXCustomizeBaseAttribute attribute, which is used to redefine the value of a property for an attribute. In a future release, the system will instead insert an attribute from the PXCustomize static class. 
...
### Edit Table Columns Dialog Box 
 ...
 Table: Edit Table Columns Dialog Box: Table Toolbar The table toolbar includes the buttons described below. 
...
### Page Toolbar and More Menu 
 ...
 Opens the Classic Dashboards (SM208680) form in a new browser tab. 

 Reload from Database 

 Updates the Dashboard items in the customization project if the dashboards that correspond to these items have been modified on the Classic Dashboards (SM208680) form. 
...
### Dialog Box Fields Table 
 ...
 This button is available if combo box values have been specified for the field in the system. 
...
- Start the customization of the inspected element 
 ...
 In the Modern UI, you can use the Element Inspector tool if you have one of the following: 

- The _Customizer_ , _Administrator_ , or _ReportDesigner_ role 

- At least _View Only_ access rights to the _Generic Inquiry_ (SM208000), _Import Scenarios_ , or _Export_     _Scenarios_ (SM207025) form 
...
- **View Data Class Source** : Opens the **Data Access** tab of the _Source Code_ browser with     the source code of the DAC to which the field for the inspected element belongs. This button appears if you have the _Customizer_ role. 
...
### Drop-Down Values Dialog Box 
 ...
 In the dialog box, you can view all possible values of the selected drop-down control and the corresponding values that are saved to the database. For details on the internal names of drop-down control values, see Combo Box: Configuration. 
...
<!-- PAGE_BREAK -->
 ...
 Table: Event Handler Properties Dialog Box: Field Update Tab In the table on the Field Update tab, you add the fields that should be updated aer the event is processed. The fields are updated in the order in which you add them to the table. You can change the order of the listed rows (and thus the corresponding fields) by clicking the row you want to move and then clicking Move Up or Move Down on the table toolbar. The table toolbar has only standard buttons. 
...
This dialog box opens if on the Fields page, you click a field that is displayed as a combo box on the applicable Acumatica ERP form and then you click **Combo Box Values** on the page toolbar. In the dialog box, you can specify or modify the values for the field you have selected. The table toolbar has only standard buttons. 
...
### Page Toolbar and More Menu 
 ...
 Table: Add Files Dialog Box This dialog box opens when you click Add New Record on the page toolbar. The dialog box contains a table that lists the files that you can add to the customization project. The table toolbar has only standard buttons. 
...
### Page Toolbar and More Menu 
 ...
 Table: Add Generic Inquiries Dialog Box This dialog box opens when you click Add New Record on the page toolbar. The dialog box displays a table listing all the custom and customized generic inquiries that exist in your instance of Acumatica ERP. The table toolbar has only standard buttons. 
...
<!-- PAGE_BREAK -->
 Import and Export Scenarios | 85 
...
- _Update Existing Screen_ (with the screen ID specified in the **Screen ID** column) 

- _Update Main Menu_ (with the _Menu_ specified in the **Screen ID** column 

- _Remove Existing Screen_ 
...
- Add: By using this page, which you open by clicking **Add New Screen** on the Mobile Application page, you     can add a new screen to the Acumatica mobile app. In the name that appears on the page, _Add_ is followed     by a colon, the screen ID, and then the screen name. 

- Remove: You use this page to remove a screen from the Acumatica mobile app. This page is opened when     you click **Remove Existing Screen** on the Mobile Application page. In the name that appears on the page,     _Remove_ is followed by a colon, the screen ID, and then the screen name. 

- Update: You use this page to update an existing screen of the Acumatica mobile app. To open this page, you     click **Update Existing Screen** on the Mobile Application page. In the name that appears on the page, _Update_     is followed by a colon, the screen ID, and then the screen name. 

- Update Menu: You use this page, which opens when you click **Update Main Menu** on the Mobile Application     page, to update the main menu of the Acumatica mobile app. The name that appears on the page is _Update:_     _MENU_. The pages have the same structure, as described below. 
 ...
 Table: Source Code Pane The Source Code pane consists of the following areas. 
...
## Modern UI Editor 
 ...
 You open the Modern UI Editor page by first expanding the Screens node in the navigation pane of the Customization Project Editor. In the list of forms displayed under the expanded Screens node, expand the node that corresponds to the form whose code you want to customize, and click the Modern UI Editor node. 
...
### Page Toolbar and More Menu 
 ...
 Edit TypeScript Extension 

 Opens the Edit TypeScript Extension dialog box, which is used to create new custom TypeScript extensions or edit existing ones. 

 Table: Add Field Dialog Box This dialog box opens when you click Add Field on the page toolbar. In the dialog box, you can add a custom field and generate a TypeScript extension. 
 ...
 Field or Display Name 

 A search box where you can type a string that’s part of the field or display name of the custom field that you want to add to the form. The system uses this string to filter the results in the table below it that lists the fields from the selected data view. 
...
<!-- PAGE_BREAK -->
 ...
 Save to Extension Generates a new extension or saves the changes to an existing one, and closes the dialog box. The file with the generated TypeScript extension is added to your customization project and listed on the Modern UI Files page of the Customization Project Editor. 

 Cancel Closes the dialog box without generating an extension or modifying an existing one. 

**_Table: Add View Wizard_** 

This wizard opens when you click **Add View** on the page toolbar. In the wizard, you can add a view and generate a TypeScript extension. 
...
**_Table: Edit TypeScript Extension Dialog Box_** 

This dialog box opens when you click **Edit TypeScript Extension** on the page toolbar. In the dialog box, you can edit an existing custom TypeScript extension or create a new one. 
...
- **Add Field** : Adds the boilerplate code for a new field. Clicking this opens a dialog box     where you specify the name of the new field and select the check box for any of the fol-     lowing optional properties: 
...
- **Disabled** You click **Add** to add the code for the new field to the extension or **Cancel** to leave the extension unchanged. 

- **Add Data View Extension** : Adds the boilerplate code for a data view extension. Click-     ing this opens a dialog box where you select the name of the base view from which you     want to derive the data view extension. You click **Add** to add the code for the data view     extension to the extension or **Cancel** to leave the extension unchanged. 
...
- **Add Grid View** : Adds the boilerplate code for a grid view. Clicking this opens a dialog     box where you select the name of the grid view that you want to add to the extension. 
...
<!-- PAGE_BREAK -->
 ...
 You click Add to add the code for the grid view to the extension or Cancel to leave the extension unchanged. 

- **Add Custom Event Handler** : Adds the boilerplate code for a custom event handler.     Clicking this opens a dialog box where you select the type of event that you want to add     to the extension. The dialog box may include additional boxes that require a value, de-     pending on the selected event type. You click **Add** to add the code for the custom event     handler to the extension or **Cancel** to leave the extension unchanged. 
 ...
 Fixes the formatting of the extension code that is displayed in the code editor and performs validation checks on the extension code to ensure correctness. 
...
<!-- PAGE_BREAK -->
 ...
 Aer customizing the properties of the selected view or field, you click Save on the page toolbar to save the changes to a TypeScript extension; or Cancel to discard all changes. 
...
### Page Toolbar and More Menu 
 ...
 Runs the check for modified files and opens the Modified Files Detected dialog box. To do this, the system compares each file in the project (in the FrontendSources\screen \src\development folder of the instance) with the original file. 

 Export to Development Folder 

 Exports the customization files listed in the table to the development folder of the instance, which is located in the FrontendSources\screen\src\ directory. 

 Table: Modified Files Detected Dialog Box This dialog box opens when you click Detect Modified Files on the page toolbar if you’ve modified any files of the customization project in the file system. The dialog box lists all custom and customized files in the development folder. It contains the following elements. 
 ...
 Table: Add Files Dialog Box This dialog box opens when you click Add New Record on the page toolbar. It contains a table with the files in the development folder, which you can add to the customization project. The table toolbar has only standard buttons. 
...
<!-- PAGE_BREAK -->
 ...
 Table: Edit File Dialog Box You use this dialog box, which opens when you click a link in the Object Name column on the page, to view and edit the selected file. The dialog box contains the following elements. 
 ...
 You can't edit system-generated extension files by using the Edit File dialog box. These files have the _generated suffix in the file name. 
...
### Page Toolbar 
 ...
 Upload Package Opens the Open Package dialog box, in which you select a deployment package file. The deployment package is a ZIP file with the contents of a customization project. After you have selected the package, you click Upload to upload it to the system and display the XML code of the customization project in the Project XML Editor. 
...
## Screen Configurations 
 ...
 You can incorporate a form configuration in a customization project as a screen configuration —that is, a ScreenConfiguration item that corresponds to the form configuration. On this page, you manage these items in the customization project. 

 You open this page by clicking Screen Configurations in the navigation pane of the Customization Project Editor. 

### Page Toolbar 

 The page toolbar includes standard buttons and a page-specific button. For the list of standard buttons, see Page Toolbar. These commands are listed in the following table in alphabetical order. 

 Button Description 

 Reload from Database 

 Updates all listed ScreenConfiguration items in the customization project if the form configurations that correspond to these items have been modified on the appropriate Acumatica ERP form. 

 Table: Add Screen Configuration Dialog Box This dialog box opens when you click Add New Record on the page toolbar. The dialog box displays all the forms for which form configurations have been created. You can select multiple forms to add their screen configurations to the project simultaneously. The dialog box contains the following elements. 
...
<!-- PAGE_BREAK -->
 Screen Configurations | 105 

### Table 

 This table contains the list of screen configurations included in the customization project and the basic settings of each of them. The columns of the table are described below. 
 ...
 The user-defined fields that have been added to the form 
...
## Screen Editor 
 ...
 You can open the Screen Editor page in a variety of ways, including by clicking the screen ID (of the form you want to customize in the navigation pane of the Customization Project Editor. You can also open it from other pages, such as Screens page. In the actual name that appears on the page, Screen Editor: is followed by the form ID of the form being customized and then the form name in parentheses. 
...
### Page Toolbar and More Menu 
 ...
 Opens the Code Editor page with the template for the extension of the graph that is bound to the form. 
...
### Attributes Tab 
 ...
 Opens the Code Editor page with the graph extension template. The template includes the field attributes and the template of the CacheAttached event handler, which you can use to replace the attributes within the graph. 
...
### Events Tab 
 ...
 Add Handler For the event that you have clicked in the table, opens the Code Editor page with the graph extension template. The template includes a code template for the event handler, so you should implement only the body of the handler. 
...
## Screens 
 ...
 You open the Screens page by clicking Screens in the navigation pane of the Customization Project Editor. 
...
### Page Toolbar and More Menu 
 ...
 Launches the conversion of the selected screen in the table to the Modern UI. When the process completes, the Modern UI Files page opens, which displays the generated files for the screen. 
 ...
 Table: Create New Screen Dialog Box This dialog box opens when you click Create New Screen on the page toolbar. The dialog box contains the following elements. 

 Element Description 

 The dialog box contains the following elements. 

 Screen ID The ID to be used for the new Acumatica ERP form, as well as for the screen in the Customization Project Editor. For more information on the format of the ID, see Form and Report Numbering. 
...
- The site map node, which appears in the **Site Map** list of project items. Also, adds the _Delete_ access rights for the _Customizer_ role to the _Access Rights_ page and specifies the _Copy from Current Tenant_ merge rule for these access rights. 
...
<!-- PAGE_BREAK -->
 Tables to Track Deleted Records | 124 
...
### Page Toolbar and More Menu 
 ...
 Manage Attributes Opens the Attributes (CS205000) form in a new browser tab so that you can view and change, if needed, the settings of the attributes used for user-defined fields. 
 ...
 Table: Add User-Defined Fields Dialog Box This dialog box opens when you click Add New Record on the page toolbar. The dialog box contains the following elements. The table toolbar has only standard buttons. 
