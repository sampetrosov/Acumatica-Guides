...
## Contents 
 ...
 Tailoring the Self-Service Portal: To Create and Design a Dashboard.......................................................... 57 

 Tailoring the Self-Service Portal: To Configure a Workspace........................................................................ 65 

 To Reset Menu Settings................................................................................................................................... 71 

 Managing Localization of the Self-Service Portal.....................................................................................72 

 Localization of the Self-Service Portal............................................................................................................72 


<!-- PAGE_BREAK -->
 Contents | 3 

 Translation Process..........................................................................................................................................73 

 Boxes that Display Translated Values.............................................................................................................77 

 To Translate Bound Strings............................................................................................................................. 78 

 To Translate Unbound Strings........................................................................................................................ 79 

 To Exclude Strings from Translation...............................................................................................................80 

 To Create a Localized Version of a Wiki Article.............................................................................................. 80 

**Self-Service Portal Form Reference........................................................................................................ 81** 

 Access Rights by Role...................................................................................................................................... 81 

 Access Rights by Screen.................................................................................................................................. 83 

 Activate License............................................................................................................................................... 84 

 Customization Projects....................................................................................................................................87 
 ...
 Wiki Access by Role........................................................................................................................................106 

 Wiki Articles....................................................................................................................................................108 

 Wiki Categories...............................................................................................................................................110 

 Wiki Editor Form for Articles......................................................................................................................... 111 

 Wiki Products................................................................................................................................................. 116 

 Wiki Site Map..................................................................................................................................................117 

 Wiki Style Sheets............................................................................................................................................118 
...
- The Acumatica ERP application instance with the _U100_SSP_Admin_2026 R1_ dataset preloaded and the Self-     Service Portal application instance have been deployed in the same database. 

 This deployment is outside of the scope of this course. 

- In the _U100_SSP_Admin_2026 R1_ dataset, on the _User Roles_ (SM201005) form of Acumatica ERP, the     _Portal Admin_ role has been assigned to the _gibbs_ user account. The user account is associated with 
...
4. Sign in to a company with the _U100_SSP_Admin_2026 R1_ dataset preloaded as system administrator by     using the _gibbs_ username and the _123_ password. 
...
2. Sign in to a company with the _U100_SSP_Admin_2026 R1_ dataset preloaded as system administrator by     using the _gibbs_ username and the _123_ password. 
...
#### System Preparation 
 ...
 Before you start creating user roles, sign in to the Self-Service Portal instance with the U100_SSP_Admin_2026 R1 dataset preloaded as system administrator by using the gibbs username and the 123 password. 
...
3. On the **Details** tab, do the following:     a. In the **First Name** box of the **Contact** section, type Ray.     b. In the **Last Name** box, type Newman.     c. In the **Job Title** box, type Assistant buyer.     d. In the **Email** box, type ray.newman@storehut.example.com.     e. In the **Address** section, clear the **Override Address** check box. Based on the address information        specified in the _STOREHUT_ business account, the system fills in the address boxes with the company's        address information. 
...
1. Launch the Acumatica ERP instance with the _U100_SSP_Admin_2026 R1_ dataset preloaded. 
...
1. While you are still viewing the _Item Sales Categories_ (IN204060) form, in the **Categories** pane, click the     _Certificates_ category (which has been predefined in the _U100_SSP_Admin_2026 R1_ dataset). 
...
9. On the table toolbar, click **Add to Cart**. Under the form toolbar, notice that a message about the item in the     cart is shown. (See the following screenshot.) 
 ...
 Figure: The items and the message in the cart 
...
1. Launch the Acumatica ERP website with the _U100_SSP_Admin_2026 R1_ dataset preloaded and sign in as     system administrator by using the _gibbs_ username and the _123_ password. 
...
#### Creation of a Dashboard 
 ...
 You can create a dashboard if you have access to the Classic Dashboards (SM208600) form. For details on managing dashboards, see Administering Dashboards. For details on designing dashboards, see Designing Dashboard Contents. 

 To add a new dashboard, on the Classic Dashboards form, you perform the following steps: 
...
<!-- PAGE_BREAK -->
 ...
 d. Managing Access to the Self-Service Portal: To Create User Types for User Accounts e. Managing Access to the Self-Service Portal: To Create User Accounts for Contacts f. Configuring Case Management in the Self-Service Portal: Implementation Activity 

5. Launch the Self-Service Portal website with the _U100_SSP_Admin_2026 R1_ dataset preloaded. 
...
8. On the form toolbar, click **Clipboard > Paste**. The system inserts and replaces the values on the tabs of the     form. 
 ...
 The system displays errors on the Navigation tab because the copied generic inquiry has a link to the form that does not exist in the Self-Service Portal. You will fix that in the next step. 
...
6. On the table toolbar, click **Add Row** , and in the row, specify the following settings:     a. **Data Field** : _CaseClass.IsInternal_     b. **Condition** : _Does Not Equal_     c. **From Schema** : Selected     d. **Value 1** : Selected 
...
3. In the **Workspace Parameters** dialog box, which opens, specify the following settings:     a. In the **Icon** box, select _inquiries_ ; this icon will be displayed in the title of the workspace. 

 You can begin typing the name of the icon into the box to quickly find the icon. 

 b. In the Area box, select Other. This is the functional area for which the workspace will be displayed. c. In the Title box, type Other. d. Click OK to save your changes and close the dialog box. The empty Other workspace has been created. In Menu Editing mode, you can see the title of the newly created workspace on the main menu panel. 
...
5. In the lower le corner of the screen, click **Exit Menu Editing** to save your changes and stop working in     Menu Editing mode. 

#### Step 7: Making the Generic Inquiry Visible for Self-Service Portal Users 
...
1. On _Generic Inquiry_ (SM208000) form, open the _PortalCases_ inquiry you have created in the activity. 

2. On the form toolbar of the _Generic Inquiry_ (SM208000) form, click the **Publish to the UI** button. The **Publish**     **to the UI** dialog box opens. 

3. In the dialog box, specify the following settings:     a. **Site Map Title** : All Cases     b. **Workspace** : _Other_     c. **Category** : _Inquiries_ 
...
#### Step 8: Verifying a Customer User's Access to the Generic Inquiry Form 
...
3. Under the **Inquiries** category, click _All Cases_ to open the generic inquiry form. 
...
4. Launch the Self-Service Portal website with the _U100_SSP_Admin_2026 R1_ dataset preloaded. 
...
1. In the Self-Service Portal, open the _Classic Dashboards_ (SM208600) form. 
...
4. In the dialog box, specify the following settings:     a. **Site Map Title** : Case Activities     b. **Workspace** : Other     c. **Category** : _Dashboards_ 
...
#### Step 2: Setting Up User Access Rights for an Administrator to the Dashboard 
 ...
 While you are still viewing the Case Activities dashboard on the Classic Dashboards (SM208600) form in the SelfService Portal, do the following: 

1. On the **Visible To:** tab, in the rows that have _Portal Admin_ , _Customer Admin_ , and _Customer User_ in the **Role**     column, make sure that _Granted_ is selected in the **Access Rights** column. 

 You can type the name of the role into the Search box in the lower part of the tab to quickly find the role. 

2. On the form toolbar, click **View**. The _Case Activities_ dashboard opens. The dashboard is empty because you     have not yet added any widgets to it. 
...
9. In the **Inquiry Parameters** dialog box, which opens, do the following:     a. Clear the **Me** check box. 


<!-- PAGE_BREAK -->
 Tailoring the Self-Service Portal | 60 

 b. Click OK. 10.In the Widget Properties dialog box (which you return to aer closing the Inquiry Parameters dialog box), select the Automatically Adjust Height check box. 11.Click Column Settings. 12.In the Column Settings dialog box, which opens, move columns from the Selected Columns list to the Available Columns list by selecting each needed column and then clicking the arrow pointing le. The Selected Columns list should contain only the following columns: 
...
5. In the **Widget Properties** dialog box, which opens, do the following:     a. In the **Icon** box, select the _visibility_ icon, which will be displayed in the widget. 
 ...
 b. In the Form box, do the following: a. Click the magnifier button. b. In the lookup table that opens, in the Search box, type orders. c. In the Title column, double-click My Orders , which closes the lookup table and fills in the Form box of the dialog box. c. In the Caption box, type My Orders. d. Click Finish to save your changes and close the dialog box. The widget is added to the workspace. 
...
#### Step 7: Selecting a Template for the Dashboard Layout 
 ...
 Suppose that you want to arrange the widgets on the dashboard so that the le column takes two-thirds of the width of the working area. With this layout, the Open Cases widget on the dashboard will be larger and easier to 


<!-- PAGE_BREAK -->
 Tailoring the Self-Service Portal | 64 

see and the _My Orders_ widget will be smaller. Further suppose that you want to place the _Unassigned Cases_ and _Assigned Cases_ widgets above the _Open Cases_ widget and the _Case Volume_ widget under the _My Orders_ widget. 
...
3. Under the **Dashboards** category, click _Case Activities_ to open the dashboard. 
...
1. Launch the Acumatica ERP website with the _U100_SSP_Admin_2026 R1_ dataset preloaded. 
...
### Access Rights by Screen 
 ...
 On this form, you can view and modify the access rights of roles to particular workspaces (that is, to all forms in a workspace), forms, containers of form elements, and form elements. For more information on roles and their access rights, see Configuring User Roles. 
...
<!-- PAGE_BREAK -->
 ...
 Restriction levels vary by object type. For some objects, you can specify a more granular level; for others, you can either allow or deny the access. For details, see User Roles: Restriction Level Options. 
...
Aer you save the changes, the system hides the string occurrences with the check box selected. 

**_Table: Default Values Table Toolbar_** 
...
#### Obsolete Tab 
 ...
 Table: Default Values Table Toolbar The table toolbar includes the buttons described below. 
...
<!-- PAGE_BREAK -->
 ...
 Table: Key-Specific Values Table Toolbar The table toolbar includes the buttons described below. 
...
**_Table: Dashboard Description Section_** 
...
#### Locales Tab 
 ...
 Table: Table Columns The table toolbar has only standard buttons. 
...
#### Table 
 ...
 Table: Update Article Properties Dialog Box You can use this dialog box to update any properties of the selected article or articles. For every box, specify the new setting (if you want to change it) or leave the box blank to leave the setting unchanged. 
...
#### Le Pane 
 ...
 This pane contains a tree-like structure of all the wikis configured in your organization with all the folders within them. The wikis are represented as first-level nodes. You can click a node icon to the le of any wiki to expand the node and view the hierarchical structure of the wiki. Some wikis have a one-level list of folders, while other wikis 


<!-- PAGE_BREAK -->
 Self-Service Portal Form Reference | 118 

 have multiple levels. When you click a node, the right pane displays the list of its items (folders and articles) with their details. 
